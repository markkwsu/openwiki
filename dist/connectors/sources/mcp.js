...
async function ingestMcpConnector(connectorId, definition, options) {
 ...
 */
async function resolveMcpConnectorConfig(connectorId, options) {
    const diskConfig = await readConnectorConfig(connectorId, {
        enabled: false,
        readOnlyOperations: [],
    });
