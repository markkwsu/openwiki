export type ConnectorId = "custom-mcp" | "git-repo" | "google" | "hackernews" | "langsmith" | "notion" | "slack" | "web-search" | "x";
export type ConnectorBackend = "direct-api" | "local-git" | "mcp-http" | "mcp-stdio";
