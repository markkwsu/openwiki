...
import { openWikiEnvDisplayPath, openWikiHomeDir, } from "../config/openwiki-home.js";
/**
 * Publishable PostHog project key. Safe to ship (client/ingestion key).
 */
export const DEFAULT_POSTHOG_KEY = "phc_Cki9DqcLbYkGudQaiaTSAfQZxXvjL6EyoaQjEJGJrwPF";
...
export const FIRST_RUN_NOTICE_VERIFY = "To see what data we capture, add the --telemetry-file=<path> to any run.";
