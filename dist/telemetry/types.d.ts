 ...
 * in `taxonomy.ts`.
 */
export type TelemetryErrorClass = "config_error" | "filesystem_error" | "provider_error" | "network_error" | "context_limit_error" | "build_error" | "connector_error" | "okf_error" | "checkpointer_error" | "tool_error" | "output_error" | "agent_error" | "aborted";
/**
 ...
 */
export type TelemetryErrorOwner = "environment" | "provider" | "openwiki" | "unowned" | "control";
/**
