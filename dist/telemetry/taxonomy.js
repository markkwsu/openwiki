 ...
 */
const OPEN_DETAIL_CLASSES = new Set([
    "connector_error",
    "tool_error",
]);
/**
 ...
 */
export function isSafeErrorIdentifier(value) {
 ...
 */
const PROVIDER_ENVIRONMENT_DETAILS = new Set([
    "auth",
    "quota_exceeded",
]);
/**
 ...
 */
const NETWORK_ENVIRONMENT_DETAILS = new Set([
    "dns",
    "refused",
]);
/**
 ...
 */
export function normalizeErrorDetail(errorClass, detail) {
    ...
    const allowed = FIXED_ERROR_DETAILS[errorClass];
 ...
 */
export function deriveOwner(errorClass, detail, stage) {
    switch (errorClass) {
        case "config_error":
            return "environment";
