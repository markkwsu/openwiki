 ...
 */
export const ENGLISH_INDEX_LABELS = {
    files: "Files",
 ...
 */
export function resolveIndexLabels(language) {
    if (!language)
        return ENGLISH_INDEX_LABELS;
    return (INDEX_LABELS[language] ??
 ...
 */
export function resolveConceptTypeLabel(language) {
    if (!language)
        return ENGLISH_CONCEPT_TYPE;
    return (CONCEPT_TYPE_LABELS[language] ??
