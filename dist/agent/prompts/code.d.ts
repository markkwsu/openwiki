export declare const CODE_SYSTEM_PROMPTS: {
...
- In repository runs the wiki is this repo-local /openwiki directory, not ${string}.
- Never type ~, ${string}, or host paths like /Users/... into filesystem tools (ls, read_file, write_file, edit_file, glob, grep).
...
export declare const CODE_USER_PROMPTS: {
