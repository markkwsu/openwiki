 ...
 */
export async function validateWikiMermaid(backend, outputMode) {
 ...
 */
async function listMarkdownFiles(backend, directoryPath) {
    ...
    for (const entry of result.files ?? []) {
        ...
        else if (path.posix.extname(name).toLowerCase() === ".md" &&
