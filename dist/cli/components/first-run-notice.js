...
import { FIRST_RUN_NOTICE_BODY, FIRST_RUN_NOTICE_OPT_OUT, FIRST_RUN_NOTICE_VERIFY, } from "../../telemetry/index.js";
 ...
 */
export function renderFirstRunNoticeText(color) {
...
export function FirstRunNotice() {
    return (_jsxs(Box, { borderStyle: "round", borderColor: "cyan", flexDirection: "column", marginBottom: 1, paddingX: 1, children: [_jsxs(Text, { children: [_jsx(Text, { bold: true, color: "cyan", children: "OpenWiki" }), " ", _jsx(Text, { color: "gray", children: "telemetry" })] }), _jsx(Text, { color: "white", children: FIRST_RUN_NOTICE_BODY }), _jsx(Text, { color: "white", children: FIRST_RUN_NOTICE_OPT_OUT }), _jsx(Text, { color: "white", children: FIRST_RUN_NOTICE_VERIFY })] }));
}
