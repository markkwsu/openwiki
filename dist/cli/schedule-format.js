 ...
 */
export function formatScheduleMutationResult(action, result) {
 ...
 */
export function formatScheduleHeader(scheduleCount) {
 ...
 */
export function formatPowerScheduleStatus(schedule) {
