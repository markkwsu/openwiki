...
export type RunState = {
    ...
    status: "setup-complete-exit";
    result: InitSetupResult;
} | {
    status: "init-setup-saved";
    result: InitSetupResult;
} | {
 ...
 */
export declare function updateRunningCredentialDiagnostics(state: RunState, credentialDiagnostics: CredentialDiagnostic[], credentialDiagnosticsRef: MutableRefObject<CredentialDiagnostic[] | undefined>): RunState;
