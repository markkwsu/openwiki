 ...
 */
export function moveInputCursor(state, offset) {
    return {
        ...state,
 ...
 */
export function deleteBeforeInputCursor(state) {
 ...
 * place.
 */
export function deleteAtInputCursor(state) {
 ...
 */
export function applyRawInputValue(state, inputValue) {
    let nextState = state;
 ...
 */
export function insertAtInputCursor(state, character) {
    return {
 ...
 */
export function clampCursorPosition(position, value) {
 ...
 */
export function isControlCharacter(character) {
 ...
 */
export function isRawBackspaceInput(inputValue) {
 ...
 * raw ESC input byte.
 */
export function isEscapeInput(inputValue, key) {
