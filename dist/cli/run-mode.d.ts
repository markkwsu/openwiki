 ...
 * `--print`).
 */
export declare function argvRequestsPrint(argv: string[]): boolean;
/**
 ...
 */
export declare function shouldPrintStartupError(argv: string[], parsedCommand: CliCommand, command: CliCommand): command is Extract<CliCommand, {
    kind: "error";
}>;
/**
 ...
 * directory.
 */
export declare function getRunModeCwd(mode: OpenWikiRunMode, codeRuntimeCwd?: string): string;
/**
 * Maps a run mode to the output mode it writes: `repository` for `code`,
 * otherwise `local-wiki`.
 */
export declare function getRunModeOutputMode(mode: OpenWikiRunMode): OpenWikiOutputMode;
/**
 ...
 */
export declare function shouldAutoExitStartupRun(command: CliCommand): boolean;
