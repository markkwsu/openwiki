...
import { commandLoadsEnvironment, commandEmitsTelemetry, parseCommand, shouldRunNonInteractively, } from "./commands.js";
import { FirstRunNotice, renderFirstRunNoticeText, } from "./components/first-run-notice.js";
import { shouldPrintStartupError } from "./run-mode.js";
import { resolveStartupCommand } from "./startup.js";
import { App } from "./app/app.js";
import { runAuthCommand, runCronCommand, runIngestCommand, runNgrokCommand, runPrintCommand, runVisualizeCommand, } from "./runners.js";
 ...
 */
async function runStandardCommand(parsedCommand) {
    ...
    if (command.kind === "auth") {
        ...
        render(_jsxs(_Fragment, { children: [showFirstRunNotice ? _jsx(FirstRunNotice, {}) : null, _jsx(App, { command: command })] }), { exitOnCtrlC: false });
    }
}
