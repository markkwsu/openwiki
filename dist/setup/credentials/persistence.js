...
import { getProviderApiKeyEnvKey, getProviderBaseUrlEnvKey, getProviderLocationEnvKey, getProviderProjectEnvKey, getProviderRegionEnvKey, getProviderSecretKeyEnvKey, OPENWIKI_MODEL_ID_ENV_KEY, OPENWIKI_PROVIDER_ENV_KEY, OPENWIKI_REASONING_EFFORT_ENV_KEY, } from "../../config/constants.js";
/**
 ...
 */
export function buildCredentialEnvUpdates(options, env) {
    const { nextApiKey, nextBaseUrl, nextGcpLocation, nextGcpProject, nextLangSmithKey, nextModelId, nextReasoningEffort = null, nextOAuthTokens, nextProvider, nextRegion, nextSecretKey, } = options;
    const updates = {};
