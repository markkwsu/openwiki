...
export type PromptStep = "api-key" | "base-url" | "code-repo-confirm" | "code-repo-path" | "external-cli-auth" | "final" | "gcp-location" | "gcp-project" | "langsmith" | "model" | "oauth-login" | "provider" | "reasoning-effort" | "region" | "run-mode" | "secret-key" | "source-auth" | "global-cron-custom" | "global-cron-mode" | "global-power-mode" | "source-description" | "source-description-custom" | "source-langsmith-key" | "source-langsmith-projects" | "source-langsmith-region" | "source-langsmith-workspaces" | "source-menu" | "source-path" | "source-confirm-continue" | "source-secret" | "template" | "wiki-goal";
