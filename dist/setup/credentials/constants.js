import { OPENWIKI_GOOGLE_CLIENT_ID_ENV_KEY, OPENWIKI_GOOGLE_CLIENT_SECRET_ENV_KEY, OPENWIKI_TAVILY_API_KEY_ENV_KEY, OPENWIKI_X_CLIENT_ID_ENV_KEY, } from "../../config/constants.js";
import { openWikiConnectorsDisplayPath, openWikiEnvDisplayPath, openWikiLocalWikiDisplayPath, } from "../../config/openwiki-home.js";
...
export const FINAL_OPTIONS = ["Run ingestion now", "Run later"];
export const CODE_REPO_OPTIONS = ["Confirm and continue", "Edit path"];
/**
